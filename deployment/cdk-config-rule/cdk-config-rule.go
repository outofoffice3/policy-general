...
func PolicyGeneralStack(scope constructs.Construct, id string, props *DeploymentStackProps) awscdk.Stack {
	...
	_ = awsconfig.NewCustomRule(stack, jsii.String("Custom"), &awsconfig.CustomRuleProps{
		...
		LambdaFunction:            awslambda.Function_FromFunctionArn(stack, jsii.String("policy general lambda"), jsii.String("FUNCTION_ARN_PLACEHOLDER")),
...
func main() {
	...
	PolicyGeneralStack(app, "Policy General", &DeploymentStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
